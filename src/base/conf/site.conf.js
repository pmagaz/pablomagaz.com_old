...
const KeyWords = 'javascript, react, redux, vue, rxjs, immutable, webassembly, wasm, rust, angular, parcel, webpack, es6, observables, programación reactiva, blog, rxjs, serviceworker, ecma 2018, pwa, progressive web app';
const numPosts = 10;
