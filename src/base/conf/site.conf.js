...
const KeyWords = 'javascript, react, redux, vue, rxjs, immutable, webassembly, wasm, microservicios, rust, angular, parcel, webpack, es6, observables, programación reactiva, blog, rxjs, serviceworker, ecma 2020, pwa, progressive web app, nodejs, rust, deno';
const numPosts = 12;
...
const cookiePushNotifications = 'EBIPushNotificationsv2';
const cookieMailSubscription = 'EBIMailSubscriptionv2';
